...
<head>
  ...
  <title>PENGAJUAN PEMBELIAN BARANG</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center">
        ...
        <div class="sidebar-brand-text mx-3">PENGAJUAN PEMBELIAN BARANG</div>
      </a>
      ...
      <?php if ($this->session->userdata('level') == 'MANAGER'): ?>
        <li class="nav-item <?php if ($page == 'Barang') {
          echo 'active';
        } ?>">
        ...
        <li class="nav-item <?php if ($page == 'Pengajuan') {
          echo 'active';
        } ?>">
        ...
        <li class="nav-item <?php if ($page == 'Historis') {
          echo 'active';
        } ?>">
          <a class="nav-link" href="<?= base_url('Historis'); ?>">
            <i class="fas fa-table"></i>
            <span>Historis Pengajuan Barang</span></a>
        </li>
